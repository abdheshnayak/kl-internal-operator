...
// 			req.Context(), &accountNodes, &client.ListOptions{
...
// 			if _, e := functions.ExecCmd(
// 				fmt.Sprintf("kubectl delete accountnode -l %s=%s", "kloudlite.io/node-pool", req.Object.Name),
// 				"",
// 			); e != nil {
// 				return e, false
// 			}
...
// 		).
// 		Watches(
// 			&source.Kind{Type: &corev1.Pod{}}, handler.EnqueueRequestsFromMapFunc(
// 				func(o client.Object) []reconcile.Request {
// 					l, ok := o.GetLabels()["kloudlite.io/node-pool"]
// 					if !ok {
// 						return nil
